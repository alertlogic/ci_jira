...
AJS.$(document).ready(
    function() {
        ...
        Bootstrap.start( currentUser, function(){
            ...
            /**
             * Clears selectors, filters and all data from the page.
             */
            ...
            /**
             * Loads the list of managed account by the current customer.
             */
            self.loadManagedAccounts = function() {
                ciAIMSService.getManagedAccounts(
                    ...
                    JIRA.Messages.showWarningMsg(
                        AJS.I18n.getText("ci.partials.common.vm.js.msg.account.managed.error")
                    );
                });
            }
            self.loadManagedAccounts();
            ...
            self.storeRules = function(){
                ...
                if( id === ''){
                    var projectIsConfigured = jiraService.ConfigureProject(project);
                    projectIsConfigured.done( function(){
                        var rulePromise = rulesService.createRule( actingAccountId, project, group, currentEnvironment, filters, ruleName);
