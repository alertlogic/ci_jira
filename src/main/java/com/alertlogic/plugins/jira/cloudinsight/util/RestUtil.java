...
public class RestUtil {
     ...
     * @throws Exception
     */
    public void setupAuthetication(String jiraUser,String actingAccountId) throws Exception{
        PluginConfig conf = this.pluginConfigService.getConfiguration( jiraUser );
        setupAuthetication( conf.getCredential(), actingAccountId );
    }
     ...
     * @throws Exception
     */
    public void setupAuthetication(Credential credential, String actingAccountId) throws Exception{
        JSONObject jsonResponse = autheticate( credential );

        this.token = getToken( jsonResponse );
        this.userId = getUserId( jsonResponse );
        this.account = (actingAccountId != null && !actingAccountId.isEmpty()) ? actingAccountId : getAccount( jsonResponse );
