...
public class SnoozeIncidentServlet extends HttpServlet{

    private static final String CONFIG_BROWSER_TEMPLATE = "/js/partials/SnoozeIncident/SnoozeIncident.vm";
    private TemplateRenderer templateRenderer;
    private PageBuilderService pageBuilderService;
    private PluginRetrievalService pluginRetrievalService;
    private final UserManager userManager;

    public SnoozeIncidentServlet(TemplateRenderer templateRenderer, PageBuilderService pageBuilderService, PluginRetrievalService pluginRetrievalService, UserManager userManager)
    {
