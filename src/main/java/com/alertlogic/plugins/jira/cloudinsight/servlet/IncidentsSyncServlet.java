...
public class IncidentsSyncServlet extends HttpServlet{
    ...
    public IncidentsSyncServlet(TemplateRenderer templateRenderer,PageBuilderService pageBuilderService,PluginRetrievalService pluginRetrievalService, UserManager userManager) {
